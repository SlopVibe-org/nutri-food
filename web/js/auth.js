...
function renderUserArea() {
 ...
 $('menu-logout').addEventListener('click', async function() { $('user-menu-dropdown').classList.remove('visible');
   try { await fetchWithTimeout(API + '/logout', { method: 'POST' }, 5000); } catch(e) { /* non-critical */ }
   clearAuth(); });
